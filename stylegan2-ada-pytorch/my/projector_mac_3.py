...
"""Project given image to the latent space of pretrained network pickle using W+ latent space and LPIPS + pixel MSE loss."""
...
def project(
    ...
    *,
    ...
    for step in range(num_steps):
        ...
        pixel_loss = F.mse_loss(synth_images, target_images)
